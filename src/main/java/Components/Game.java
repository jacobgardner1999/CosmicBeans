...
public class Game {
    ...
    private Choice generateChoices() {
        ...
        Choice c3_0 = choiceFactory.createChoice("You detour away from your normal walk to work onto a street you've never been on before. In fact... you're certain this road wasn't here last time you walked through this way. You definitely need a coffee. As you get to the door you notice a sign in the window. \"Serving now, hot bean juice with milk\". Quirky... you think to yourself.", "3_0");
        Choice c3_1 = choiceFactory.createChoice("The second you decide against going to the new shop you get a text from your boss. \"Coffee.\" I guess you're going to the coffee shop after all. You rush back so you can still make it in time for work.", "3_1");
        ...
        Choice c4_0 = choiceFactory.createChoice("", "4_0");
        ...
        Choice c6_1 = choiceFactory.createChoice("You continue to sleep in every day. You work. You go home. You sleep. Every day the same. One day at work you overhear a conversation about the local coffee shop closing down. Someone remarks about that being sad. You continue working. Continue sleeping in. Continue existing.", "6_1");
